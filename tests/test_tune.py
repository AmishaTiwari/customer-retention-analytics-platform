"""Data-quality invariant tests for models/tune.py's Logistic Regression search.
...
to get real preprocessed X_train/y_train, and assert claims about
tune_logistic_regression's actual behavior on that data and the real
loaded config.
"""
...
from retention_platform.models.tune import tune_logistic_regression
